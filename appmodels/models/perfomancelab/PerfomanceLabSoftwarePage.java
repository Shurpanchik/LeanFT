...
public class PerfomanceLabSoftwarePage extends AppModelBase {		private AutoTestLink AutoTestLink;
	
	public PerfomanceLabSoftwarePage(TestObject contextTestObject) throws GeneralLeanFtException
	{
		setName("PerfomanceLabSoftwarePage");
				AutoTestLink = new AutoTestLink(contextTestObject, this);
		rebuildDescriptions();
	}	

			public AutoTestLink AutoTestLink() { return AutoTestLink; }

		public class AutoTestLink extends LinkNodeBase
	{

		
								public AutoTestLink(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

			
			setDisplayName("AutoTestLink");
		}
		...
		protected com.hp.lft.sdk.web.LinkDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.LinkDescription.Builder().xpath("//*[@id=\"post-929\"]/div/div/div[1]/div[2]/ul/li[3]/a").build();
			}catch(Exception e){
