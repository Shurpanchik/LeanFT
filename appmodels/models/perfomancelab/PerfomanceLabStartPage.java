...
public class PerfomanceLabStartPage extends AppModelBase {		private ServicesAndProductsItem ServicesAndProductsItem;
	
	public PerfomanceLabStartPage(TestObject contextTestObject) throws GeneralLeanFtException
	{
		setName("PerfomanceLabStartPage");
				ServicesAndProductsItem = new ServicesAndProductsItem(contextTestObject, this);
		rebuildDescriptions();
	}	

			public ServicesAndProductsItem ServicesAndProductsItem() { return ServicesAndProductsItem; }

		public class ServicesAndProductsItem extends WebElementNodeBase
	{

		
			private TestItem TestItem;
						public ServicesAndProductsItem(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

					TestItem = new TestItem(this, applicationModel);

			setDisplayName("ServicesAndProductsItem");
		}
		...
		protected com.hp.lft.sdk.web.WebElementDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.WebElementDescription.Builder().id("menu-item-317").build();
			}catch(Exception e){
			...
			return description;
				...
				public TestItem TestItem() { return TestItem; }
		
			public class TestItem extends WebElementNodeBase
	{

		
								public TestItem(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
		...
		protected com.hp.lft.sdk.web.WebElementDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.web.WebElementDescription description = null; 
			try{
				description = new com.hp.lft.sdk.web.WebElementDescription.Builder().outerHTML("<a href=\"http://www.performance-lab.ru/software-testing\">Тестирование</a>").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
