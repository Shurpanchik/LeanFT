...
public class SearchPage extends AppModelBase {		private SearchPanel SearchPanel;
	
	public SearchPage(TestObject contextTestObject) throws GeneralLeanFtException
	{
		setName("SearchPage");
				SearchPanel = new SearchPanel(contextTestObject, this);
		rebuildDescriptions();
	}	

			public SearchPanel SearchPanel() { return SearchPanel; }

		public class SearchPanel extends WebElementNodeBase
	{

		
								public SearchPanel(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

			
			setDisplayName("SearchPanel");
		}
		...
		protected com.hp.lft.sdk.web.WebElementDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.WebElementDescription.Builder().id("lst-ib").build();
			}catch(Exception e){
