...
public class SearchResults extends AppModelBase {		private PerfomanceLabLink PerfomanceLabLink;
	
	public SearchResults(TestObject contextTestObject) throws GeneralLeanFtException
	{
		setName("SearchResults");
				PerfomanceLabLink = new PerfomanceLabLink(contextTestObject, this);
		rebuildDescriptions();
	}	

			public PerfomanceLabLink PerfomanceLabLink() { return PerfomanceLabLink; }

		public class PerfomanceLabLink extends LinkNodeBase
	{

		
								public PerfomanceLabLink(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

			
			setDisplayName("PerfomanceLabLink");
		}
		...
		protected com.hp.lft.sdk.web.LinkDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.LinkDescription.Builder().href("http://www.performance-lab.ru/").build();
			}catch(Exception e){
