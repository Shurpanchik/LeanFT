...
public class Notepad extends AppModelBase {		private MenuFile MenuFile;
	
	public Notepad(TestObject contextTestObject) throws GeneralLeanFtException
	{
		setName("Notepad");
				MenuFile = new MenuFile(contextTestObject, this);
		rebuildDescriptions();
	}	

			public MenuFile MenuFile() { return MenuFile; }

		public class MenuFile extends UiObjectNodeBase
	{

		
								public MenuFile(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

			
			setDisplayName("MenuFile");
		}
		...
		protected com.hp.lft.sdk.winforms.UiObjectDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.winforms.UiObjectDescription.Builder().text("Файл").build();
			}catch(Exception e){
	...
	public abstract class UiObjectNodeBase extends AppModelNodeBase<com.hp.lft.sdk.winforms.UiObject, com.hp.lft.sdk.winforms.UiObjectDescription> implements com.hp.lft.sdk.winforms.UiObject
	{		
